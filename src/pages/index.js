...
import { FaGithub, FaLinkedin, FaAngellist, FaEnvelope } from "react-icons/fa"
          ...
          <Row>
            <Col xs={4} className='avatar'>
              ...
              <div className="social">
                ...
                {siteConfig.social.angel && <a className="social-link angellist" href={siteConfig.social.angel}>
                  <FaAngellist className="social-icon" size="32" />
                </a>}
